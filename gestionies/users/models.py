...
class User(AbstractUser):
    ...
    dni = models.CharField(_("Card ID Number"), blank=True, max_length=20, db_index=True)
    usuario_rayuela = models.CharField(_("Rayuela User"), blank=True, max_length=50)
    foto = ImageField(_("User photo"), upload_to=upload_to, blank=True)
    es_usuario = models.BooleanField(_("Is Rayuela User"), default=False)
    id_usuario = models.CharField(_("Rayuela User ID"), blank=True, max_length=20)
